...
Except for the file identified in the next section, the map artwork in this directory was downloaded from [re3mr](https://reemr.se/).

- Creator: re3mr
- Copyright: © 2025 re3mr
- License: [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International](https://creativecommons.org/licenses/by-nc-sa/4.0/)
- Modifications: resized proportionally and converted to WebP for web delivery; no editorial changes
