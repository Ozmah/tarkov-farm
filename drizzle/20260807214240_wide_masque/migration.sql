...
CREATE UNIQUE INDEX `map_images_one_current_per_map_idx` ON `map_images` (`map_id`) WHERE "map_images"."is_current" = 1;--> statement-breakpoint
CREATE INDEX `screenshots_location_id_idx` ON `screenshots` (`location_id`);