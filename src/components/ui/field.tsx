...
function FieldLegend({
	...
	return (
		<legend
			...
			className={cn(
				"mb-3 font-semibold text-primary uppercase data-[variant=label]:text-xs data-[variant=legend]:text-xs",
				className,
			)}
			{...props}
		/>
...
function Field({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: This generic field wrapper can be nested inside a fieldset.
		<div
			role="group"
			data-slot="field"
