...
function SelectTrigger({
	...
	return (
		<SelectPrimitive.Trigger
			...
			data-size={size}
			className={cn(
				"flex w-fit items-center justify-between gap-1.5 whitespace-nowrap rounded-none border border-transparent border-b-input bg-transparent px-3 py-2 text-sm outline-none transition-[color,border-color,box-shadow] focus-visible:border-b-ring focus-visible:ring-2 focus-visible:ring-ring/30 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-b-destructive data-[size=default]:h-11 data-[size=sm]:h-10 data-placeholder:text-muted-foreground *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-1.5 motion-reduce:transition-none dark:aria-invalid:border-b-destructive/50 [&_svg:not([class*='size-'])]:size-3.5 [&_svg]:pointer-events-none [&_svg]:shrink-0",
				className,
			)}
			{...props}
		>
